...
urlpatterns = [
    ...
    path('step/5/', views.Step5PaymentView.as_view(), name='step5'),
    path('step/6/', views.Step6DoctorView.as_view(), name='step6'),
    path('step/7/', views.Step7SignatureView.as_view(), name='step7'),
    path('step/8/', views.Step8SummaryView.as_view(), name='step8'),
    path('step/9/', views.Step9TicketView.as_view(), name='step9'),
    # HTMX & AJAX
